  ...
  return (
    <QwikCityProvider>
      ...
      <body
        lang="en"
        class={[
          "flex min-h-[100dvh] flex-col scroll-smooth bg-[linear-gradient(rgba(13,13,13,0.95),rgba(13,13,13,0.95)),url(/images/backgrounds/umbilical.webp)] bg-cover bg-fixed bg-center text-body",
